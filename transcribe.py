...
def transcribe(
    ...
    **decode_options,
    ...
    at_time_res: Optional[float]
        Optional change the time resolution of audio tagging, in seconds, e.g., 10 for 10 seconds, must be an integer multiple of 0.4, e.g., 0.4, 0.8, 1.2, 1.6, etc.
    ...
    model.at_model = model.at_model.to('cuda:0')
    with tqdm.tqdm(
        ...
        while seek < content_frames:
            ...
            mel_segment=mel_segment.to('cuda:0')
            decode_options["prompt"] = all_tokens[prompt_reset_since:]
            result: DecodingResult = decode_with_fallback(mel_segment)
            #print(seek, content_frames)
            # print(result.audio_features_for_at.shape)
            # print(result.audio_features_for_at.dtype)
            ...
            #print(cur_at_start, cur_at_end)
            all_audio_tags[cur_at_start: cur_at_end, :] = audio_tag[0:cur_at_end-cur_at_start, :].detach().cpu() # this avoids error for the last slice
